...
├── middleware/
│   ├── AuthMiddleware.php        # Verifies JWT on protected routes
│   └── RoleMiddleware.php        # requireRole('super_admin') etc.
├── controllers/
│   ├── AuthController.php
...
```
c:\Users\nobs.is.coding\Desktop\medicationadherence\medical\
├── lib/
│   ├── main.dart                 # App initialization (OneSignal, ProviderScope)
│   ├── app.dart                  # Root MaterialApp, Theme, Router config
...
│   │       ├── auth_service.dart # JWT storage & state logic
│   │       ├── onesignal_service.dart
│   │       └── storage_service.dart
│   ├── router/
│   │   ├── app_router.dart       # GoRouter definitions & Guards
│   │   └── route_utils.dart      # Route names and path constants
│   ├── sharedwidgets/            # App-wide UI components
│   │   ├── app_bar.dart
│   │   ├── custom_button.dart
...
│   │   │   └── presentation/
│   │   │       ├── screens/
│   │   │       │   └── adherence_report_screen.dart
│   │   │       └── widgets/
│   │   │       |   └── adherence_charts.dart
                └── providers/
...
│   │   │       │   ├── medication_library_screen.dart
│   │   │       │   └── create_prescription/
│   │   │       │       ├── create_prescription_screen.dart # The Stepper
│   │   │       │       ├── steps/
│   │   │       │       │   ├── info_step.dart
│   │   │       │       │   ├── meds_step.dart
│   │   │       │       │   ├── advice_step.dart
...
│   │   │       │   ├── assign_patient_screen.dart
│   │   │       │   └── hospital_reports_screen.dart
                └── providers/
│   │   │           └── hosipital_provider.dart
│   │   ├── notifications/
│   │   │   ├── domain/
│   │   │   │   └── models/
...
│   │   │       └── providers/
│   │   │           └── notification_polling_provider.dart
│   │   ├── patient/
│   │   │   ├── data/
...
### Server Requirements
- PHP 7.4+ with extensions: `pdo_mysql`, `mbstring`, `json`, `curl`, `fileinfo`, `openssl`
- MySQL 8.0+
